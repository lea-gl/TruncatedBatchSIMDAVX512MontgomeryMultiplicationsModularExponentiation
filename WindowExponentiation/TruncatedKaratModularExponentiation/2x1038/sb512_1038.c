...
inline void force_inline mul512_8_1038K(__m512i out[40], __m512i a512[20], __m512i b512[20])
{
	...
	D1_10 = (D1_10<<1)+carry;
	D1_9 &= mask51;
	D1_10 = _mm512_add_epi64(D1_10,D2_0);	carry = D1_10>>52;
	D1_11 = (D1_11<<1)+carry;
	D1_10 &= mask52;
...
inline void force_inline square512_8_1038K(__m512i out[40], __m512i a512[20])
{
	...
	D0_19 = _mm512_madd52hi_epu64(zero,a5129,a5129);
	...
	D2_19 = _mm512_madd52hi_epu64(zero,a51219,a51219);
	...
	carry  = _mm512_srli_epi64(D1_0,52);
	D1_0 = _mm512_and_si512(D1_0,mask52);
D1_1 = _mm512_add_epi64(D0_11,D1_1);	D1_1 = _mm512_add_epi64(D1_1,carry);
	carry  = _mm512_srli_epi64(D1_1,52);
D1_2 = _mm512_add_epi64(D0_12,D1_2);	D1_2 = _mm512_add_epi64(D1_2,carry);
	D1_1 = _mm512_and_si512(D1_1,mask52);
	carry  = _mm512_srli_epi64(D1_2,52);
D1_3 = _mm512_add_epi64(D0_13,D1_3);	D1_3 = _mm512_add_epi64(D1_3,carry);
	D1_2 = _mm512_and_si512(D1_2,mask52);
	carry  = _mm512_srli_epi64(D1_3,52);
D1_4 = _mm512_add_epi64(D0_14,D1_4);	D1_4 = _mm512_add_epi64(D1_4,carry);
	D1_3 = _mm512_and_si512(D1_3,mask52);
	carry  = _mm512_srli_epi64(D1_4,52);
D1_5 = _mm512_add_epi64(D0_15,D1_5);	D1_5 = _mm512_add_epi64(D1_5,carry);
	D1_4 = _mm512_and_si512(D1_4,mask52);
	carry  = _mm512_srli_epi64(D1_5,52);
D1_6 = _mm512_add_epi64(D0_16,D1_6);	D1_6 = _mm512_add_epi64(D1_6,carry);
	D1_5 = _mm512_and_si512(D1_5,mask52);
	carry  = _mm512_srli_epi64(D1_6,52);
D1_7 = _mm512_add_epi64(D0_17,D1_7);	D1_7 = _mm512_add_epi64(D1_7,carry);
	D1_6 = _mm512_and_si512(D1_6,mask52);
	carry  = _mm512_srli_epi64(D1_7,52);
D1_8 = _mm512_add_epi64(D0_18,D1_8);	D1_8 = _mm512_add_epi64(D1_8,carry);
	D1_7 = _mm512_and_si512(D1_7,mask52);
	carry  = _mm512_srli_epi64(D1_8,52);
D1_9 = _mm512_add_epi64(D0_19,D1_9);	D1_9 = _mm512_add_epi64(D1_9,carry);
	D1_8 = _mm512_and_si512(D1_8,mask52);
