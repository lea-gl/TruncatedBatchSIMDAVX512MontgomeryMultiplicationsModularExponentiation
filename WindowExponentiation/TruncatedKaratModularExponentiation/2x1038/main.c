...
int main(void){
	...
	fexpand_8_512_1038K( n_prime_512, a64);
	...
	//block_mont_mul512_8_1038K(aMont512, a512, r2_512, n512, n_prime512);
	//block_mont_mul512_8_1038K(bMont512, b512, r2_512, n512, n_prime512);
	
	mont_mul512_8_1038K(aMont512, a512, r2_512, n512, n_prime_512);
	mont_mul512_8_1038K(bMont512, b512, r2_512, n512, n_prime_512);
	...
	mont_mul512_8_1038K(resMont512, aMont512, bMont512, n512, n_prime_512);
	...
	//block_mont_mul512_8_1038K(res512, resMont512, un512, n512, n_prime512);
	
	mont_mul512_8_1038K(res512, resMont512, un512, n512, n_prime_512);
	...
	*********************/
	...
	for(int k=0; k<NSAMPLES;k++){
		...
		for(int i=0;i<NTEST;i++)
		{
			mont_mul512_8_1038K(res512, a512, b512, n512, n_prime_512);
		}
