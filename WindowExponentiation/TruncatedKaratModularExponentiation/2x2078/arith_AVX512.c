...
modExp_8_512(unsigned long int out[8][NB_COEFF64], unsigned long int a[8][NB_COEFF64], unsigned long int e[8][NB_COEFF64], __m512i n[NB_COEFF], __m512i n_prime[NB_COEFF],  __m512i r2[NB_COEFF])
{
	...
	//mont_mul512_8_2078K(out512, un512, r2, n, n_prime);// a0 = a x R
...
#endif//*/
	{
		...
		//block_mont_mul512_8_2078K(a1_512, a0_512, a1_512, n, n_prime);// a1 = a1 x a0 x R
	...
	//block_mont_mul512_8_2078K(a1_512, a0_512, un512, n, n_prime);
