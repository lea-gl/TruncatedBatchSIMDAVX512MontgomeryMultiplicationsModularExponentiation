...
int main(void){
	...
	fexpand_8_512_4154KK( n_prime_512, a64);
	...
	//block_mont_mul512_8_4154KK(aMont512, a512, r2_512, n512, n_prime512);
	//block_mont_mul512_8_4154KK(bMont512, b512, r2_512, n512, n_prime512);
	
	mont_mul512_8_4154KK(aMont512, a512, r2_512, n512, n_prime_512);
	mont_mul512_8_4154KK(bMont512, b512, r2_512, n512, n_prime_512);
	...
	mont_mul512_8_4154KK(resMont512, aMont512, bMont512, n512, n_prime_512);
	...
	//block_mont_mul512_8_4154KK(res512, resMont512, un512, n512, n_prime512);
	
	mont_mul512_8_4154KK(res512, resMont512, un512, n512, n_prime_512);
	...
	*********************/
	...
	printf("\ngmp, BN, BN_MONT, block_mont_mul512_8_4154KK, W=%d\n",WIN_WIDTH);
	printf("-----------------------------------------------------------\n");
	...
	for(int k=0; k<NSAMPLES;k++){
		...
		for(int i=0;i<NTEST;i++)
		{
			mont_mul512_8_4154KK(res512, a512, b512, n512, n_prime_512);
		}
	...
	*********************/
	...
	printf("\ngmp, BN, BN_MONT, block_mont_mul512_8_4154KK\n");
	printf("-----------------------------------------------------------\n");
