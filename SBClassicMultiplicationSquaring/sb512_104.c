...
inline void force_inline mul512_8_SIZE(__m512i out[4], __m512i a512[2], __m512i b512[2])
{
	__m512i out0, out1;
	__m512i out2, out3;
...
inline void force_inline square512_8_SIZE(__m512i out[4], __m512i a512[2])
{
	__m512i out0, out1;
	__m512i out2, out3;
