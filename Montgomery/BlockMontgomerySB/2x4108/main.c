...
int main(void){
	...
	block_mont_mul512_8_4108(resMont512, aMont512, bMont512, n512, n_prime512);
	...
	*********************/
	...
	for(int k=0; k<NSAMPLES;k++){
		...
		for(int i=0;i<NTEST;i++)
		{
			block_mont_mul512_8_4108(res512, a512, b512, n512, n_prime512);
		}
	...
	printf("timer block_mont_mul512_8_4108     : %llu\n",timer2/(NSAMPLES*10));
	...
	*********************/
	...
	printf("block_mont_mul512_8_4108     : %llu\n",timer2/(NSAMPLES*10));
