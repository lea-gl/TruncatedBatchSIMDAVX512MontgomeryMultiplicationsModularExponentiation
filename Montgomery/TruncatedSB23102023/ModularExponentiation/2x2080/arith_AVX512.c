...
modExp_8_512(unsigned long int out[8][NB_COEFF64], unsigned long int a[8][NB_COEFF64], unsigned long int e[8][NB_COEFF64], __m512i n[NB_COEFF], __m512i n_prime[1], __m512i r2[NB_COEFF])
{
	...
	mont_mul512_8_2080(a0_512, un512, r2, n, n_prime);// a0 = a x R
	
	mont_mul512_8_2080(a1_512, a1_512, r2, n, n_prime);// a0 = a x R
	//mont_square512_8_2080(a1_512, a1_512, n, n_prime2);// a1 = a^2 x R
	...
	for(int i = 2047; i>=0;i--)
	{
		...
		mont_mul512_8_2080(a1_512, a0_512, a1_512, n, n_prime);// a1 = a1 x a0 x R

		//block_mont_mul512_8_1040(a0_512, a0_512, a0_512, n, n_prime);// a0 = a0^2 x R
		mont_square512_8_2080(a0_512, a0_512, n, n_prime);// a1 = a^2 x R
	...
	mont_mul512_8_2080(a1_512, a0_512, un512, n, n_prime);
