...
//B  : 0x2FF840F228B9DD042D4293752B389B16FC2DA9452477361149CDB308E7E3EEA3DABABCE990390610B722C12DAE6F1763DCA1816CCE2A931DEA13D0AF732FEF0D
		...
		/*from_int_to_amns(pa, A);
		from_int_to_amns(pb, B);
		pa[0] = 0xfffffffffffffff;
		pb[0] = 0xfffffffffffffff;
		...
		pa[5] = 0xfffffffffffffff;
		pb[5] = 0xfffffffffffffff;
		pa[6] = 0;
		pb[6] = 0;
		pa[7] = 0;
		pb[7] = 0;
	...
	for(int i=0;i<NTEST;i++)
	{
		...
		/*if(res[1]^res_gmp[1]) flag1++;
		flag1?counter1++,flag1=0:counter1,flag1=0;
		printf("i = %d\n",i);
		displayVect(res,"res    ",NB_COEFF);
		displayVect(res_gmp,"res_gmp",NB_COEFF);
		getchar();*/
