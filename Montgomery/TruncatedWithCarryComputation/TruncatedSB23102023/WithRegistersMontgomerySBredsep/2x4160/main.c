...
int main(void){
	...
	mont_mul512_8_4160(aMont512, a512, r2_512, n512, n_prime512);
	mont_mul512_8_4160(bMont512, b512, r2_512, n512, n_prime512);
	
	displayVect512_NB_COEFF(aMont512,"aMont512");
	displayVect512_NB_COEFF(bMont512,"bMont512");
	
	
	mont_mul512_8_4160(resMont512, aMont512, bMont512, n512, n_prime512);
	
	// back to standard domain
	
	mont_mul512_8_4160(res512, resMont512, un512, n512, n_prime512);
	...
	for(int i=0;i<NTEST;i++)
	{
		...
		mont_square512_8_4160(resMont512, aMont512, n512, n_prime512);
	...
	*********************/
	...
	for(int k=0; k<NSAMPLES;k++){
		...
		for(int i=0;i<NTEST;i++)
		{
			mont_mul512_8_4160(res512, a512, b512, n512, n_prime512);
		}
		...
		for(int i=0;i<NTEST;i++)
		{
			mont_square512_8_4160(res512, a512, n512, n_prime512);
		}
	...
	printf("timer mont_square512_8_4160        : %llu\n",timer6/(NSAMPLES*10));
	...
	*********************/
	...
	printf("mont_mul512_8_4160           : %llu\n",timer2/(NSAMPLES*10));
	
	printf("mont_square512_8_4160        : %llu\n",timer6/(NSAMPLES*10));
