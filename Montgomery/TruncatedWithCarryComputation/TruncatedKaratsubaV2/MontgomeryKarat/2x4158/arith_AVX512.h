...
//void fexpand_8_512_52(__m512i * output, const unsigned long int in[8][NB_COEFF64_SLICE]);
...
void
mont_mul512_8_4158K(__m512i out[NB_COEFF], __m512i a512[NB_COEFF], __m512i b512[NB_COEFF], __m512i n[NB_COEFF],  __m512i n_prime[NB_COEFF]);

void
mont_square512_8_4158K(__m512i out[NB_COEFF], __m512i a512[NB_COEFF], __m512i n[NB_COEFF],  __m512i n_prime[NB_COEFF]);
