...
for SIZE in {260}:#{1040,2080,4160}:#
	...
	for i in range(1,t-1):
		...
		line = "\n\t//T = a_iB\n\n\tt512[0] = _mm512_madd52lo_epu64(zero,a512["+str(i)+"],b512[0]);\n"
		f.write(line)
		line = "\tt512[1] = _mm512_madd52hi_epu64(zero,a512["+str(i)+"],b512[0]);\n"
		f.write(line)
	...
	line = "\tout512["+str(t-1)+"] = _mm512_madd52lo_epu64(zero,a512["+str(t-1)+"],b512[0]);\n"
	f.write(line)
	line = "\tout512["+str(t)+"] = _mm512_madd52hi_epu64(zero,a512["+str(t-1)+"],b512[0]);\n"
	f.write(line)
