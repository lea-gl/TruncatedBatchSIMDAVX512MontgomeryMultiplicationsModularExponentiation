...
modExp_8_512(unsigned long int out[8][NB_COEFF64], unsigned long int a[8][NB_COEFF64], unsigned long int e[8][NB_COEFF64], __m512i n[NB_COEFF], __m512i n_prime[NB_COEFF],  __m512i r2[NB_COEFF])
{
	...
	mont_mul512_8_4108(g512[0], un512, r2, n, n_prime);// a0 = a x R
	mont_mul512_8_4108(g512[1], g512[1], r2, n, n_prime);// a0 = a x R
	
#if WIN_WIDTH>=2
	
	mont_square512_8_4108(g512[2], g512[1], n, n_prime);// g^2
	mont_mul512_8_4108(g512[3], g512[1],g512[2] , n, n_prime);// g^3

#endif	
#if  WIN_WIDTH>=3
	
	mont_square512_8_4108(g512[4], g512[2], n, n_prime);// g^4
	mont_mul512_8_4108(g512[5], g512[1],g512[4] , n, n_prime);// g^5
	mont_square512_8_4108(g512[6], g512[3], n, n_prime);// g^6
	mont_mul512_8_4108(g512[7], g512[1],g512[6] , n, n_prime);// g^7

#endif	
#if  WIN_WIDTH>=4

	mont_square512_8_4108(g512[8], g512[4], n, n_prime);// g^8
	mont_mul512_8_4108(g512[9], g512[1],g512[8] , n, n_prime);// g^9
	mont_square512_8_4108(g512[10], g512[5], n, n_prime);// g^10
	mont_mul512_8_4108(g512[11], g512[1],g512[10] , n, n_prime);// g^11
	mont_square512_8_4108(g512[12], g512[6], n, n_prime);// g^12
	mont_mul512_8_4108(g512[13], g512[1],g512[12] , n, n_prime);// g^13
	mont_square512_8_4108(g512[14], g512[7], n, n_prime);// g^14
	mont_mul512_8_4108(g512[15], g512[1],g512[14] , n, n_prime);// g^15
	...
	mont_square512_8_4108(g512[16], g512[8], n, n_prime);// g^16
	mont_mul512_8_4108(g512[17], g512[1],g512[16] , n, n_prime);// g^17
	mont_square512_8_4108(g512[18], g512[9], n, n_prime);// g^18
	mont_mul512_8_4108(g512[19], g512[1],g512[18] , n, n_prime);// g^19
	mont_square512_8_4108(g512[20], g512[10], n, n_prime);// g^20
	mont_mul512_8_4108(g512[21], g512[1],g512[20] , n, n_prime);// g^21
	mont_square512_8_4108(g512[22], g512[11], n, n_prime);// g^22
	mont_mul512_8_4108(g512[23], g512[1],g512[22] , n, n_prime);// g^23
	mont_square512_8_4108(g512[24], g512[12], n, n_prime);// g^24
	mont_mul512_8_4108(g512[25], g512[1],g512[24] , n, n_prime);// g^25
	mont_square512_8_4108(g512[26], g512[13], n, n_prime);// g^26
	mont_mul512_8_4108(g512[27], g512[1],g512[26] , n, n_prime);// g^27
	mont_square512_8_4108(g512[28], g512[14], n, n_prime);// g^28
	mont_mul512_8_4108(g512[29], g512[1],g512[28] , n, n_prime);// g^29
	mont_square512_8_4108(g512[30], g512[15], n, n_prime);// g^30
	mont_mul512_8_4108(g512[31], g512[1],g512[30] , n, n_prime);// g^31
	...
	//mont_mul512_8_4108(out512, un512, r2, n, n_prime);// a0 = a x R
	...
	mont_mul512_8_4108(out512, a0_512, out512, n, n_prime);// a1 = a1 x a0 x R
...
#endif//*/
	{
		...
		//block_mont_mul512_8_4108(a1_512, a0_512, a1_512, n, n_prime);// a1 = a1 x a0 x R
		
		
		for(int i=0;i<WIN_WIDTH;i++)
			mont_square512_8_4108(out512, out512, n, n_prime);// a1 = a^2 x R
		mont_mul512_8_4108(out512, a0_512, out512, n, n_prime);// a1 = a1 x a0 x R
	...
	//block_mont_mul512_8_4108(a1_512, a0_512, un512, n, n_prime);
	
	
	mont_mul512_8_4108(out512, out512, un512, n, n_prime);
